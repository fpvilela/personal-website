...
-   When editing resume YAML files, write user-facing items as polished website copy. Start each item with an uppercase letter and end each sentence with a period.
